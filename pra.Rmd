...
```
#### Dataset Dimensions
```{r q1_datadimensions, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE}
...
```{r q1b_mode, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE}
...
```{r q1b_frequency_tables, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE}
library(knitr)
...
```{r q1b_frequency_tables_color, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE}
...
```{r q1b_frequency_tables_clrty, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE}
...
```{r q1c_plots, echo=TRUE, message=FALSE, warning=FALSE, fig.width=12, fig.height=8}
# ---- (1c) Visualisations of Variable Distributions ----

# 1) Numeric variables: histograms (distributions)
...
# 2) Categorical variables: barplots (distributions)
...
```{r q4a, echo=TRUE, fig.width=12, fig.height=6, out.width="100%"}
library(ggplot2)
